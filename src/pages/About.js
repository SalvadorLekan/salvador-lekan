    ...
    return (
        <div className='pt-10'>
            <article className='min-h-full flex flex-col'>
                <section className='inline-block self-start'><span className='text-xl sm:text-2xl font-semibold xl:text-3xl'>Salvador AbdulRahman Lekan</span><span className=' block w-full bg-red-600 h-1'></span></section>
                ...
                {/* <section>
                    ...
                    <div className='flex flex-wrap justify-evenly'>
                        <section className='flex flex-col items-center'><p className='text-xl sm:text-2xl sm:font-bold'></p></section>
                        <section className='flex flex-col items-center'><p className='text-xl sm:text-2xl sm:font-bold'></p></section>
                        <section className='flex flex-col items-center'><p className='text-xl sm:text-2xl sm:font-bold'></p></section>
                    </div>
                </section> */}
